...
class MusicViewModel: NSObject {
    ...
    {
        let alert = UIAlertController(title: Constants.warning.localized, message: Constants.noInternetConnectionMsg.localized, preferredStyle: UIAlertController.Style.alert)
